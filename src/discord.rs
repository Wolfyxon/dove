...
use serenity::{Client, FutureExt, all::{ChannelId, Context, CreateMessage, EventHandler, GatewayIntents, GuildId, Message, Ready}, async_trait};
...
impl DiscordHandler {
    ...
    pub async fn create_loop(token: String, tx: Sender<DiscordCommEvent>, mut rx: Receiver<DiscordCommEvent>) {
...
impl EventHandler for DiscordHandler {
    async fn message(&self, ctx: Context, msg: Message) {
        ...
        self.transmit_to_gui(DiscordCommEvent::MessageReceived(msg)).await;
    }
